...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        self.text_area = Text(frame, width=600, height=550, yscrollcommand=scrollbar.set, padx=10, pady=10, font=(self.font_type, self.font_size))
